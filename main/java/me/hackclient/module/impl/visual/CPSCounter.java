...
public class CPSCounter extends Module {
    ...
    public void onEvent(Event event) {
        ...
        if (event instanceof Render2DEvent) {
            ...
            if (shadows.isToggled() && shadows.cpsCounter.isToggled()) BloomUtils.addToDraw(() -> RoundedUtils.drawRect(posHorizontal.getValue(), posVertical.getValue(), width + 4, mc.fontRendererObj.FONT_HEIGHT + 4, radius.getValue(), Color.WHITE));
            ...
            mc.fontRendererObj.drawString(text,posHorizontal.getValue() + 2 ,posVertical.getValue() + 2, textColor.getColor().getRGB(), textShadow.isToggled());
        }
    }
}
