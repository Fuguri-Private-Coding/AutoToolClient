...
public abstract class EntityLivingBase extends Entity
{
    ...
    {
        this.dataWatcher.updateObject(6, MathHelper.clamp(health, 0.0F, getMaxHealth()));
    }
        ...
        if (this.isServerWorld())
        {
            if (!this.isInWater() || this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying)
            {
                if (!this.isInLava() || this instanceof EntityPlayer && ((EntityPlayer)this).capabilities.isFlying)
                {
                    ...
                    {
                        float f6 = 0.15F;
                        this.motionX = MathHelper.clamp(this.motionX, (double)(-f6), (double)f6);
                        this.motionZ = MathHelper.clamp(this.motionZ, (double)(-f6), (double)f6);
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.newPosRotationIncrements > 0)
        {
            ...
            double d3 = MathHelper.wrapDegree(this.newRotationYaw - (double)this.rotationYaw);
