...
public class EntityAIControlledByPlayer extends EntityAIBase
{
    ...
    public void updateTask()
    {
        ...
        float f = MathHelper.wrapDegree(entityplayer.rotationYaw - this.thisEntity.rotationYaw) * 0.5F;
        ...
        this.thisEntity.rotationYaw = MathHelper.wrapDegree(this.thisEntity.rotationYaw + f);
