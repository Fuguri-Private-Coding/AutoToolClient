...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob
{
    ...
    public double[] getMovementOffsets(int p_70974_1_, float p_70974_2_)
    {
        ...
        double d1 = MathHelper.wrapDegree(this.ringBuffer[j][0] - d0);
    ...
    public void onLivingUpdate()
    {
        ...
        else
        {
            ...
            this.rotationYaw = MathHelper.wrapDegree(this.rotationYaw);
            ...
            else
            {
                ...
                if (this.worldObj.isRemote)
                {
                    if (this.newPosRotationIncrements > 0)
                    {
                        ...
                        double d2 = MathHelper.wrapDegree(this.newRotationYaw - (double)this.rotationYaw);
                ...
                else
                {
                    ...
                    double d6 = MathHelper.wrapDegree(d4 - (double)this.rotationYaw);
    ...
    {
        return (float)MathHelper.wrapDegree(p_70973_1_);
    }
