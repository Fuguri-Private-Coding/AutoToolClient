...
public class Main {
    public static void main(String[] p_main_0_) {
        ...
        OptionSpec<String> optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo("AutoTool" + Minecraft.getSystemTime() % 1000L);
        ...
        Session session = new Session(optionspec9.value(optionset), s4, optionspec11.value(optionset), (String) optionspec18.value(optionset));
