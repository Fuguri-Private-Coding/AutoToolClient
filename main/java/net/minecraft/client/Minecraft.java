...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private static final ResourceLocation locationMojangPng = new ResourceLocation("minecraft", "hackclient/splashscreen/splash.png");
    ...
    private void setWindowIcon() {
        ...
        if (util$enumos != Util.EnumOS.OSX) {
            ...
            try {
                ...
                logger.error("Couldnt set icon", ioexception);
            } finally {
        ...
        if (this.mcProfiler.profilingEnabled) {
            ...
            for (Profiler.Result result : list) {
                ...
                for (int i3 = i1; i3 >= 0; --i3) {
                    float f3 = (float) ((d0 + ((Profiler.Result) result).field_76332_a * (double) i3 / (double) i1) * Math.PI * 2.0D / 100.0D);
                ...
                tessellator.draw();
                d0 += ((Profiler.Result) result).field_76332_a;
            }
