...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void initStream() {
        try {
            ...
            logger.error("Couldnt initialize twitch stream");
        }
    }
    ...
    private void createDisplay() throws LWJGLException {
        ...
        try {
            ...
            logger.error("Couldnt set pixel format", lwjglexception);
    ...
    private void runGameLoop() throws IOException {
        ...
        RunGameLoopEvent.getInstance().call(false);
        ...
        for (int j = 0; j < this.timer.elapsedTicks; ++j) {
            TickEvent tickEvent = TickEvent.getInstance();
            tickEvent.call();
    ...
    public int getLimitFramerate() {
        if (!Display.isActive()) return 30;
        if (currentScreen != null) return 144;
...
//                throw new ReportedException(crashreport);
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput) {
            ...
            while (Keyboard.next()) {
                ...
                KeyEvent keyEvent = KeyEvent.getInstance();
                keyEvent.setKey(key);
                keyEvent.setPressed(Keyboard.getEventKeyState());
                keyEvent.call();
                ...
                if (Keyboard.getEventKeyState()) {
                    if (key == 62 && this.entityRenderer != null) {
                    ...
                    if (this.currentScreen != null) {
                        ...
                        if (key == 32 && Keyboard.isKeyDown(61) && this.ingameGUI != null) {
                            this.ingameGUI.getChatGUI().clearChatMessages();
                        }
            ...
            ClickEvent clickEvent = ClickEvent.getInstance();

            BestClickTimingEvent.getInstance().call();
            ...
            if (this.thePlayer.isUsingItem()) {
                ...
                LegitClickTimingEvent.getInstance().call();

                while (this.gameSettings.keyBindAttack.isPressed()) {
                    clickEvent.setButton(ClickEvent.Button.LEFT);
                    clickEvent.call();
                ...
                while (this.gameSettings.keyBindUseItem.isPressed()) {
                    clickEvent.setButton(ClickEvent.Button.RIGHT);
                    clickEvent.call();
                ...
                while (this.gameSettings.keyBindPickBlock.isPressed()) {
                    clickEvent.setButton(ClickEvent.Button.MIDDLE);
                    clickEvent.call();
                ...
                if (Keyboard.getEventKeyState()) {
                    if (i == this.gameSettings.keyBindStreamStartStop.getKeyCode()) {
                        if (this.getTwitchStream().isBroadcasting()) {
                            ...
                            this.displayGuiScreen(new GuiYesNo((result, _) -> {
                                if (result) {
