...
import fuguriprivatecoding.autotool.event.events.Render2DEvent;
import fuguriprivatecoding.autotool.event.events.Render3DEvent;
import fuguriprivatecoding.autotool.module.impl.visual.BlockOverlay;
import fuguriprivatecoding.autotool.module.impl.visual.CustomCamera;
...
public class EntityRenderer implements IResourceManagerReloadListener {
            ...
            if (this.mc.currentScreen != null) {
                ...
                try {
                    ...
                    crashreportcategory.addCrashSectionCallable("Mouse location", new Callable<String>() {
                        public String call() throws Exception {
                            return String.format("Scaled: (%d, %d). Absolute: (%d, %d)", new Object[]{k1, l1, Mouse.getX(), Mouse.getY()});
                        }
                    });
    ...
    public void setupOverlayRendering() {
        ...
        GlStateManager.matrixMode(5889);
        GlStateManager.loadIdentity();
        GlStateManager.ortho(0.0D, scaledresolution.getScaledWidthD(), scaledresolution.getScaledHeightD(), 0.0D, 1000.0D, 3000.0D);
        GlStateManager.matrixMode(5888);
        GlStateManager.loadIdentity();
