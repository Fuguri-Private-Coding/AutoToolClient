...
import fuguriprivatecoding.autotool.event.events.RenderItemEvent;
import fuguriprivatecoding.autotool.event.events.UpdateRenderingItem;
...
public class ItemRenderer {
    ...
    public void updateEquippedItem() {
        ...
        float f1 = MathHelper.clamp(f - this.equippedProgress, -f2, f2);
