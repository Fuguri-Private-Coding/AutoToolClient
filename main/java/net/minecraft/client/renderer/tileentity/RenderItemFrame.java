                ...
                else
                {
                    ...
                    if (item == Items.compass)
                    {
                        ...
                        if (textureatlassprite instanceof TextureCompass)
                        {
                            ...
                            texturecompass.updateCompass(itemFrame.worldObj, itemFrame.posX, itemFrame.posZ, (double)MathHelper.wrapDegree((float)(180 + itemFrame.facingDirection.getHorizontalIndex() * 90)), false, true);
