            ...
            if (args.length != 1 && args.length != 2)
            {
                ...
                else if (entity.worldObj != null)
                {
                    ...
                    if (entity instanceof EntityPlayerMP)
                    {
                        ...
                        if (!commandbase$coordinatearg4.func_179630_c())
                        {
                            f1 = MathHelper.wrapDegree(f1);
                        }

                        if (f1 > 90.0F || f1 < -90.0F)
                        {
                            f1 = MathHelper.wrapDegree(180.0F - f1);
                            f = MathHelper.wrapDegree(f + 180.0F);
                        }
                    ...
                    {
                        float f2 = (float)MathHelper.wrapDegree(commandbase$coordinatearg3.func_179628_a());
                        float f3 = (float)MathHelper.wrapDegree(commandbase$coordinatearg4.func_179628_a());

                        if (f3 > 90.0F || f3 < -90.0F)
                        {
                            f3 = MathHelper.wrapDegree(180.0F - f3);
                            f2 = MathHelper.wrapDegree(f2 + 180.0F);
                        }
