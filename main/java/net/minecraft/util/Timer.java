...
public class Timer {
    ...
    public void updateTimer() {
        ...
        long j = time - this.lastSyncSysClock;
        ...
        double d2 = MathHelper.clamp((d0 - this.lastHRTime) * this.timeSyncAdjustment, 0.0D, 1.0D);
        this.lastHRTime = d0;
        this.elapsedPartialTicks += (float) (d2 * timerSpeed * ticksPerSecond);
