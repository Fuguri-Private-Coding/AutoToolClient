package fuguriprivatecoding.autotoolrecode.utils.player.inventory;
...
public class InventoryUtils implements Imports {
    ...
    public static boolean isValid(ItemStack stack) {
        ...
        return switch (stack.getItem()) {
            case ItemBlock _ -> isGoodBlockStack(stack);
            case ItemSword _ -> isBestSword(stack);
            case ItemTool _ -> isBestTool(stack);
            case ItemArmor _ -> isBestArmor(stack);
            case ItemPotion _ -> isBuffPotion(stack);
            case ItemFood _ -> isGoodFood(stack);
            case ItemEnderPearl _ -> true;
            case null, default -> isGoodItem(stack);
        };
    }
