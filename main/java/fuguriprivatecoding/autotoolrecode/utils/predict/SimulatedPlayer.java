package fuguriprivatecoding.autotoolrecode.utils.predict;
...
public class SimulatedPlayer implements Imports {
    ...
    private void clampPositionFromEntityPlayer() {
        double d3 = MathHelper.clamp(posX, -2.9999999E7, 2.9999999E7);
        double d4 = MathHelper.clamp(posZ, -2.9999999E7, 2.9999999E7);
        if (d3 != posX || d4 != posZ) {
