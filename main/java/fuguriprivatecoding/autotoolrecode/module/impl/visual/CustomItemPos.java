...
public class CustomItemPos extends Module {
    ...
    public FloatSetting x = new FloatSetting("X", this, -2,2,1,0.01f);
    public FloatSetting y = new FloatSetting("Y", this, -2,2,1,0.01f);
    public FloatSetting z = new FloatSetting("Z", this, -2,2,1,0.01f);
