...
import fuguriprivatecoding.autotoolrecode.guis.buttons.ImgButton;
...
public class MainScreen extends GuiScreen {
    ...
    public void initGui() {
        ...
        buttonList.add(new fuguriprivatecoding.autotoolrecode.guis.buttons.Button(0, sc.getScaledWidth() / 2 - 100, sc.getScaledHeight() / 2 + 25,"SinglePlayer"));
        buttonList.add(new fuguriprivatecoding.autotoolrecode.guis.buttons.Button(1, sc.getScaledWidth() / 2 - 100, sc.getScaledHeight() / 2 + 25 + 25, "MultiPlayer"));
        buttonList.add(new fuguriprivatecoding.autotoolrecode.guis.buttons.Button(2, sc.getScaledWidth() / 2 - 100, sc.getScaledHeight() / 2 + 25 + 25 + 25, "MinecraftSetting"));
